...
class Game:
    def __init__(self):
        ...
        self.start_img = useful.scale_image(self.start_img,
    ...
    def display_score(self):
        ...
        score_surf = self.font.render(f'Score: {current_time}', True,
                                      self.settings.BLACK)
        score_rect = score_surf.get_rect(midtop=(self.screen_w / 2, 0))
        print(score_rect.midtop)
